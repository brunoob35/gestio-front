...
import "./ProfessorSettingsPage.css";
...
export default function ProfessorSettingsPage() {
  ...
  return (
    <ProfessorShell title="Configurações">
      <div className="professor-settings">
        <section className="professor-settings__hero">
          <h2>Configurações</h2>
          <p>Atualize seus dados de acesso e informações pessoais.</p>
        </section>

        <div className="professor-settings__grid">
          <section className="professor-settings__panel">
            <header className="professor-settings__panel-header">
              <h3>Meus Dados</h3>
              <p>Essas informações pertencem ao usuário autenticado.</p>
            </header>

            {profileError ? (
              <div className="professor-settings__feedback professor-settings__feedback--error">
                {profileError}
              </div>
            ) : null}
            {profileSuccess ? (
              <div className="professor-settings__feedback professor-settings__feedback--success">
                {profileSuccess}
              </div>
            ) : null}

            <form className="professor-settings__form" onSubmit={handleSaveProfile}>
              <div className="professor-settings__form-grid">
                <label>
                  <span>Nome</span>
                  <input
                    name="nome"
              ...
              <div className="professor-settings__actions">
          ...
          <section className="professor-settings__panel">
            ...
            <form className="professor-settings__form" onSubmit={handleSavePassword}>
              <div className="professor-settings__form-grid professor-settings__form-grid--single">
                <label>
